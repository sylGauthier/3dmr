...
testing "no light"; (
    ./demo -t 1 -s "out/phong_no_light.png" "icosphere:2,4;phong:color(1,0,1),phong(default)" >/dev/null 2>&1 || fail "screenshot"
...
testing "ambient only"; (
    ./demo -t 1 -s "out/phong_ambient_only.png" -La 1,1,1 "icosphere:2,4;phong:color(1,0,1),phong(default)" >/dev/null 2>&1 || fail "screenshot"
...
testing "directional back"; (
    ./demo -t 1 -s "out/phong_directional_back.png" -Ld '0,0,1;1,1,1' "icosphere:2,4;phong:color(1,0,1),phong(default_no_spec)" >/dev/null 2>&1 || fail "screenshot"
...
testing "directional front"; (
    ./demo -t 1 -s "out/phong_directional_front.png" -Ld '0,0,-1;1,1,1' "icosphere:2,4;phong:color(1,0,1),phong(default)" >/dev/null 2>&1 || fail "screenshot"
