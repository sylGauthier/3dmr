...
testing "small cube - tux"; (
    ...
    convert assets/png/tux.png -flip -interpolate Nearest -filter point -geometry '94x94!' -flatten -gravity center -background black -extent 640x480 "out/expected_solid_texture.png" 2>&- || fail "gen expected"
