...
testing "small cube"; (
    ./demo -t 1 -s "out/test_solid_color.png" "cube:2.0165;solid:color(1,0,1)" >/dev/null 2>&1 || fail "screenshot"
...
testing "big cube"; (
    ./demo -t 1 -s "out/test_solid_color_big.png" "cube:40.0;solid:color(1,0,1)" >/dev/null 2>&1 || fail "screenshot"
