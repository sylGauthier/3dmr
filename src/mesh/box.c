...
int make_box(struct Mesh* dest, float width, float height, float depth) {
    ...
    VERTEX( 1,     a, -b, -c,     0,  0, -1,     1, 0);
    VERTEX( 2,     a,  b, -c,     0,  0, -1,     1, 1);
    ...
    VERTEX(10,    -a,  b,  c,     0,  0,  1,     0, 1);
    VERTEX(11,     a,  b,  c,     0,  0,  1,     1, 1);
    VERTEX(12,    -a, -b, -c,    -1,  0,  0,     0, 0);
    VERTEX(13,    -a,  b, -c,    -1,  0,  0,     1, 0);
    VERTEX(14,    -a,  b,  c,    -1,  0,  0,     1, 1);
    ...
    VERTEX(22,     a, -b,  c,     1,  0,  0,     0, 1);
    VERTEX(23,     a,  b,  c,     1,  0,  0,     1, 1);
    VERTEX(24,    -a, -b, -c,     0, -1,  0,     0, 0);
    VERTEX(25,     a, -b, -c,     0, -1,  0,     1, 0);
    VERTEX(26,     a, -b,  c,     0, -1,  0,     1, 1);
    VERTEX(27,    -a, -b, -c,     0, -1,  0,     0, 0);
    VERTEX(28,    -a, -b,  c,     0, -1,  0,     0, 1);
    VERTEX(29,     a, -b,  c,     0, -1,  0,     1, 1);
    VERTEX(30,    -a,  b, -c,     0,  1,  0,     0, 0);
    VERTEX(31,     a,  b, -c,     0,  1,  0,     1, 0);
    VERTEX(32,     a,  b,  c,     0,  1,  0,     1, 1);
